...
The mean of the original data containing missing value is **`r mean1`**. 
And the mean of the data after filling the missing value is **`r mean2`**.

```{r}
median1 <- as.integer(median(total_daily_steps$steps))
median2 <- as.integer(median(total_daily_steps2$steps))
```
The median of the original data containing missing value is **`r median1`**. 
And the median of the data after filling the missing value is **`r median2`**.
